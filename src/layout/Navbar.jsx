...
const Navbar = () => {
  return (
    <section className='w-full h-auto px-4 bg-white/20 shadow-md'>
      <nav className='w-full h-14 flex flex-row items-center justify-around'>
        ...
        <div className='w-auto h-14 flex flex-row items-center justify-center gap-2'>
          ...
          <Link className='h-10 px-4 flex items-center justify-center font-semibold bg-green-500 rounded-lg font-bold' to="/login">LogIn</Link>
        </div>
      </nav>
    </section>
  )
